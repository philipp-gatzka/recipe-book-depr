package net.internalerror.security;
...
public class JwtService {
    ...
    public String generateToken(User user) {
        return generateToken(SecurityConfiguration.UserDetailsRecord.of(user));
    }
    ...
    private String buildToken(Map<String, Object> extraClaims, UserDetails userDetails, long lifetime) {
        return Jwts.builder()
